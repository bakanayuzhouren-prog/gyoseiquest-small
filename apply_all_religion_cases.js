...
console.log('Preparing to update Constitution index 60 to 69 (Questions 61-70)...');
...
console.log(`Updated ${updatedCount} questions (Indices 60-69).`);
