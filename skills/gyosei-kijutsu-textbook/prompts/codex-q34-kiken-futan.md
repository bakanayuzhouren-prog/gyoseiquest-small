...
- **543条は解除の根拠ではない。** 債権者帰責なら解除**不可**の条文。引渡前・双方無過失の解除に543を付けない。
...
- 引渡**後**・双方無過失は567条1項（拒めない・解除できない）。コマ2の主戦場は受領遅滞。引渡後はひっかけ側に小さく置いてよい。
...
| 答え帯 | 引渡し前に双方のせいなく家が滅失したときは、買主は代金の支払を拒むことができる。 |
...
- 暗記:「渡す前の落雷は拒める。消すなら解除」
Answer EXACT:
「引渡し前に双方のせいなく家が滅失したときは、買主は代金の支払を拒むことができる。」
```
