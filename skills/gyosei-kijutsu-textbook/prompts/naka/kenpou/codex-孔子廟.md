...
住民訴訟の3事件比較は別ファイル（`gyosei/codex-住民訴訟.md`）。

- 保存: `assets/images/deepdive/naka/kenpou/koushibyou.png`
- キー: `naka/kenpou/koushibyou`

## 法律（守る）

- 最大判令3.2.24。20条3項の宗教的活動 → **違憲**
- 物差しは空知太型の**総合考慮**。津・愛媛の目的効果と入れ替えない
- 住民訴訟で叩くのは**怠る事実**（賃料を取らない）。愛媛・大阪の支出型と混ぜない

## 禁止

- GO と YES 混在／だれが／問が聞くこと／（聞かない）
- 「観光・文化なら合憲」を正しい結論にしない
