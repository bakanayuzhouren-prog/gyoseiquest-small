...
01 型OK後に1枚。その他は別コマ（04）。

- 保存先: `assets/images/deepdive/learn/kiso/kasuru.png`
- 画像キー: `learn/kiso/kasuru`

## 法律の芯（崩すな）

- **科する**: 刑罰・**過料**。過料は刑罰ではないが漢字は「科する」。
- **課する**: 税・義務などの負担。
...
|----|------|
| タイトル対比 | 科する＝罰／課する＝負担 |
| 中央メタファー | 二本のハンコ（科の木偏 vs 課の言偏） |
| 判断軸 | 過料も科する。税は課する |
| ひっかけ | 過料＝課する |
| 暗記 | 刑と過料は科する。税・義務は課する |
| 役割 | 裁判所（過料を科したい）／行政庁（税を課したい） |
