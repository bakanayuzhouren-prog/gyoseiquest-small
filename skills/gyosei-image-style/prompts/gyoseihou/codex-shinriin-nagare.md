...
- 29条2項: 相当の期間を定めて、処分庁等に弁明書の提出を求める。試験では**提出義務**。
- 29条5項: 弁明書の提出があったときは、これを審査請求人及び参加人に送付する。
- 30条1項: 審査請求人は反論書を**提出することができる**（義務ではない。期間を定めたときはその期間内）。
- 30条2項: 参加人は意見書を**提出することができる**（義務ではない。期間を定めたときはその期間内）。参加人の意見書と、42条の審理員意見書を混ぜない。
...
- 反論書・参加人の意見書は「提出できる（義務なし）」。弁明書は処分庁等が提出する**義務**。審理員は提出を求める。
...
③ 反論・意見を受ける（30条）
審査請求人 → 審理員:「反論書」（提出できる。義務なし）
参加人 → 審理員:「意見書」（提出できる。義務なし。審理員意見書ではない）
...
判断軸「審理と意見書は審理員。裁決は審査庁。弁明書は処分庁等の義務。反論書・意見書はできる」
ひっかけ「審理員が裁決する → × ／ 弁明書を提出するのは審査請求人 → × ／ 反論書・意見書の提出は義務 → × ／ 審理員意見書と事件記録を審査庁へ提出 → ○」
