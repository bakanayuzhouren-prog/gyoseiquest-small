...
- **必ず着衣。** 濃緑ブレザー＋白シャツ＋ネクタイ＋ズボン＋靴。参照は `approved-chachalot-pointer.png`。
- **裸は不合格。** 肌色むき出しの胴体、スーツなし、パンツなし、下着だけ、頭だけ浮いて胴体がない、は描かない。
...
6. 不一致がある場合は全体を再設計せず、該当箇所だけ局所編集する。局所で直せない崩壊（熊化・別人・名札）は**不合格**。法律が正しくても完成にしない。再生成する。
