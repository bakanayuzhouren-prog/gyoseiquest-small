...
import {
  SHOHOU_CHAT_BRIEFS,
  SHOHOU_KEY_PHRASES,
  SHOHOU_PHRASE_ALIASES,
} from '@/utils/chatTopicBriefsShouhou';
import {
  MINPOU_CHAT_BRIEFS,
  MINPOU_KEY_PHRASES,
...
import {
  ...
  MINPOU_COMPARISON_KEY_PHRASES,
  MINPOU_COMPARISON_PHRASE_ALIASES,
} from '@/utils/chatTopicBriefsMinpouComparisons';
import {
...
const PHRASE_ALIASES: [string, string[]][] = [
  ...
  ['所得倍増', ['国民所得倍増計画', '1960']],
  ['戦後経済', ['戦後日本経済', '国民所得倍増計画']],
  ['無償割当て', ['株式の消却', '株式の併合', '株式の分割']],
  ['事務監査', ['事務監査請求', '住民監査請求', '住民訴訟']],
  ['裁判員', ['裁判員制度']],
  ...KISO_HOUGAKU_PHRASE_ALIASES,
  ...GYOSEI_SORON_PHRASE_ALIASES,
  ...GYOSEI_SORON_NET_PHRASE_ALIASES,
