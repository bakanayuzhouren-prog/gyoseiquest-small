...
if (explainLineIdx === -1) {
    console.error('Target question 8 not found');
    process.exit(1);
}

console.log(`Updating line ${explainLineIdx + 1}...`);
lines[explainLineIdx] = `        "explain": "${comparisonExplain}",`;
