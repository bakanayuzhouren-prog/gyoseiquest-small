...
try {
    ...
    const c9_fraud_v2 = `[[big:1. 原則：単なる「黙秘」は詐術ではない]]
...
| **黙秘 ＋ 誤信を強める言動**（判例のケース） | [[red:あたる]] | [[red:できない]] |`;
    ...
    lines[5266] = `        "explain": ${JSON.stringify(c9_fraud_v2)},`;

    console.log("Saving back to file...");
    fs.writeFileSync(targetPath, lines.join('\n'));
    console.log("Successfully updated src/questions.js for index 9 (Fraud refined)");
