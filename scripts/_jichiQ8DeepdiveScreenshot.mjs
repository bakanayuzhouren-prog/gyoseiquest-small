...
const OUT = path.join(ROOT, 'jichi-q8-deepdive-cap.png');

/** 地方自治法「直接請求」問: questions.js index 14, 正解肢 index 3 (4.) */
const QUIZ_INDEX = 14;
const CHOICE_INDEX = 3;
const CHOICE_LABEL = '4.';
...
try {
  ...
  await page.waitForFunction(
    () => {
      ...
      return /50分の1/.test(t) && /3分の1/.test(t) && /もっと深掘/.test(t);
    },
    null,
    { timeout: 90_000 },
  );
